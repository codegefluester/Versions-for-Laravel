...
class Version {
	...
	**/
	public static function unfreeze($document_id) {
		$data = DB::table(Version::getVersionsTable())->where_id($document_id)->first();
	...
	**/
	public static function getFrozenObjects($object_id, $object_table) {
		return DB::table(Version::getVersionsTable())->where('object_id', '=', $object_id)->where('object_table', '=', $object_table)->get();
	}
	...
	*/
	public static function getLatestFreeze($object_id, $object_table) {
		return DB::table(Version::getVersionsTable())->where('object_id', '=', $object_id)->where('object_table', '=', $object_table)->order_by('created_at', 'desc')->first();
	}
